...
for (i in 1:length(defensins)) {
    flipped_upset[,i] <- as.numeric(as.character(flipped_upset[,i]))
}

flipped_upset[flipped_upset >=1] <- 1
flipped_upset[flipped_upset < 1] <- 0


upset(flipped_upset, nsets=3, text.scale=2)
